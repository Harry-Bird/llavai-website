...
Each item is a blog guide to write at blog/<slug>/index.html.
Tick [x] once the page is live.
...
- [ ] What documents do you need to rent in Barcelona? — NIE, payslips, bank statements, aval bancario explained. Slug: documents-to-rent-barcelona
...
- [ ] How to spot and avoid rental scams in Barcelona — red flags, safe payment rules, what to verify. Slug: avoid-rental-scams-barcelona
